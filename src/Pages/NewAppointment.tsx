...
export function NewAppointment() {
  const { professional, services, removeService, removeProfessional, resetAppointment } = useAppointment()
  ...
  async function handleSubmit() {
    ...
    alert('Atendimento criado com sucesso. Aguarde o chamado de um dos nossos atendentes.')
    resetAppointment()
  }
  ...
  return (
    <div className="grid grid-cols-12">
      ...
      <div className="py-16 col-span-10">
        ...
        <p className="text-lg text-center mb-8">Confira as informações do seu novo atendimento. Após submissão um funcionário irá entrar em contato para que possemos iniciar.</p>
        <div className="m-20">
          <section>
            <div className="flex items-center gap-5">
              <h2 className="text-2xl">Profissional</h2>
              <Link to="/profissionais" className="flex justify-center items-center bg-indigo-500 hover:bg-indigo-600 text-white rounded-full text-xl w-10 h-10">+</Link>
            </div>
            {
              professional == null && <span className="text-lg">Selecione um profissional clicando no "+"</span>
            }
          ...
          <section>
            <div className="flex items-center gap-5">
              ...
              <Link to="/services" className="flex justify-center items-center bg-indigo-500 hover:bg-indigo-600 text-white rounded-full text-xl w-10 h-10">+</Link>
            </div>
            {
              services.length === 0 && <span className="text-lg">Adicione serviços clicando no "+"</span>
            }
            <div className="flex justify-start items-center min-h-32 my-5">
              {
